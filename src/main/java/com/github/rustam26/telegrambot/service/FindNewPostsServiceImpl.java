...
import com.github.rustam26.telegrambot.javarushclient.JavaRushPostClient;
...
public class FindNewPostsServiceImpl implements FindNewPostsService {
    ...
    @Autowired
    public FindNewPostsServiceImpl(GroupSubService groupSubService, JavaRushPostClient javaRushPostClient,
